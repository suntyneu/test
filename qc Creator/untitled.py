...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(120, 80, 581, 341))
        ...
        self.gridLayout.addWidget(self.columnView_2, 1, 0, 1, 1)
        self.undoView = QtWidgets.QUndoView(self.gridLayoutWidget)
        self.undoView.setObjectName("undoView")
        self.gridLayout.addWidget(self.undoView, 1, 2, 1, 1)
        self.columnView = QtWidgets.QColumnView(self.gridLayoutWidget)
        self.columnView.setObjectName("columnView")
        self.gridLayout.addWidget(self.columnView, 1, 1, 1, 1)
